"use client";
import { Box, Heading, Text, VStack, List, Code, Link } from "@chakra-ui/react";
          ...
          <VStack align="start" spacing={10} color="white">
            ...
            <Box>
              ...
              <Text fontSize="md">
                特别感谢{" "}
                <Link
                  href="https://misskey.crystelf.top/@crystelf"
                  isExternal
                  color="blue.200"
                >
                  @crystelf
            ...
            <Box>
              ...
              <List.Root colorPalette="gray" spacing="2">
                ...
                <List.Item>
                  <strong>代理服务器：</strong>
                  <Code colorPalette="green">5M / 20M BGP 优质网络</Code>
                </List.Item>
              </List.Root>
            </Box>
          </VStack>
